...
async function GetAllDataPembangunansDB(access_id) {
    try {
        ...
        const queryText = `
            ...
            ON PP.id_pembangunan = max_progress_table.id_pembangunan
            AND PP.progress_pembangunan = max_progress_table.max_progress
...
module.exports={GetAllDataPembangunansDB,
    getDataPembangunanDB,
    AddDataPembangunanToDB,
    UpdatePembangunanToDB
}